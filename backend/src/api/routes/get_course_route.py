...
from backend.src.service.get_courses import add_course_by_user,search_course_by_title, user_courses, get_course_by_id
...
from backend.src.api.schemas import CourseOut, UserCourseOut
...
async def get_course(
    ...
    return await get_course_by_id(session=session, course_id=course_id, user=user)
